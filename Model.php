...
class application
{
    ...
    $sql = "INSERT INTO applications(FullName, Mobile, Email, Address, Nationality, Education, Degree_enrollment, Apply_for, Demand_salary, Starting_in, Came_From,Reason, Comments, Month_ID, User_ID) VALUES 
    ('".$this->f."','".$this->M."','".$this->e."','".$this->Add."','".$this->N."','".$this->Edu."','".$this->D."','".$this->APP."','".$this->Dem."','".$this->Start."','".$this->CameF."','".$this->reas."','".$this->Comm."','".$this->Month_ID."','".$this->User_ID."')";
    ...
    $sql = "UPDATE `applications` SET `FullName`='".$this->f."',`Mobile`='".$this->M."',`Email`='".$this->e."',`Address`='".$this->Add."',`Nationality`='".$this->N."',`Education`='".$this->Edu."',`Degree_enrollment`='".$this->D."',`Apply_for`='".$this->APP."',`Demand_salary`='".$this->Dem."',`Starting_in`='".$this->Start."',`Came_From`='".$this->CameF."',`Reason`='".$this->reas."',`Comments`='".$this->Comm."',`Month_ID`='".$this->Month_ID."',`User_ID`='".$this->User_ID."' WHERE ID ='".$ID."'";
