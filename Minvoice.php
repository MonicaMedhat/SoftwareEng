...
$sql="SELECT VALUE,c1.CaseNumber AS cn,T3.FullName AS us ,f1.Total as tot,f1.ID as fID, M.Name as MN ,f4.Paid AS paid,f5.Type AS exType From payment_options_value p1
